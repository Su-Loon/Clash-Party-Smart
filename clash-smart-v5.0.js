...
//     - Meta AI 对话入口 meta.ai
//     - Mistral AI 新子域 chat.mistral.ai / console.mistral.ai
//     - AI 编程工具：codeium.com(Cursor竞品后端) / windsurf.ai / devin.ai / cognition.ai / replit.com
//     - AI 推理平台：cerebras.ai / cloud.cerebras.ai / sambanova.ai
//     - AI 生成平台：fal.ai / ideogram.ai / leonardo.ai
//     - 快手可灵AI视频生成：klingai.com
//     - DeepSeek 国际聊天入口 chat.deepseek.com → AI代理（区别于 deepseek.com → 国内直连）
//     - 中国AI服务直连兜底：kimi.ai / chatglm.cn / minimax.chat / hailuoai.com / stepfun.com 等
//   [流媒体] 新增 4 条规则：
//     - Disney+ Hotstar（hotstar.com）→ 📺 东南亚流媒体（印度/东南亚最大流媒体平台）
//     - JioCinema（jiocinema.com）→ 📺 东南亚流媒体（印度免费流媒体）
//     - Amazon MGM+（mgmplus.com）→ 🇺🇸 美国流媒体
//     - Astro Go（astro.com.my）→ 📺 东南亚流媒体（马来西亚主流流媒体）
//   [游戏] 新增 12 条规则：
//     - Roblox（roblox.com）→ 🎮 国外游戏（全球最大UGC游戏平台）
//     - Minecraft/Mojang（minecraft.net / mojang.com）→ 🎮 国外游戏
//     - Krafton/PUBG（krafton.com / pubg.com）→ 🎮 国外游戏
//     - Level Infinite（levelinfinite.com）→ 🎮 国外游戏（腾讯国际发行品牌）
//     - 韩国游戏厂商：nexon.com / ncsoft.com / plaync.com / pearlabyss.com / smilegate.com
//     - Yostar（yostar.com / yostar.jp）→ 🎮 国外游戏（碧蓝航线/明日方舟日服发行商）
//     - Moonton（moonton.com）→ 🎮 国外游戏（Mobile Legends开发商）
...
function injectRules(config) {
  config.rules = [
    ...
    // ── v5.3.0: 中国AI服务直连兜底 ──
    // 月之暗面 Kimi
    `DOMAIN-SUFFIX,kimi.ai,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,moonshot.cn,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,kimi.moonshot.cn,${BIZ.CN_SITE}`,
    // 智谱 GLM
    `DOMAIN-SUFFIX,chatglm.cn,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,zhipuai.cn,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,bigmodel.cn,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,open.bigmodel.cn,${BIZ.CN_SITE}`,
    // MiniMax / 海螺AI
    `DOMAIN-SUFFIX,minimax.chat,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,hailuoai.com,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,hailuoai.cn,${BIZ.CN_SITE}`,
    // 阶跃星辰 StepFun
    `DOMAIN-SUFFIX,stepfun.com,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,stepchat.com,${BIZ.CN_SITE}`,
    // 阿里通义千问
    `DOMAIN-SUFFIX,tongyi.aliyun.com,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,dashscope.aliyuncs.com,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,qwen.ai,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,qwenlm.ai,${BIZ.CN_SITE}`,
    // 百度文心一言
    `DOMAIN-SUFFIX,yiyan.baidu.com,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,ernie.baidu.com,${BIZ.CN_SITE}`,
    // 科大讯飞星火
    `DOMAIN-SUFFIX,xfyun.cn,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,xinghuo.xfyun.cn,${BIZ.CN_SITE}`,
    // 字节豆包（国内版）
    `DOMAIN-SUFFIX,doubao.com,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,coze.cn,${BIZ.CN_SITE}`,
    // 零一万物 Yi
    `DOMAIN-SUFFIX,01.ai,${BIZ.CN_SITE}`,
    `DOMAIN,largest-model.cn,${BIZ.CN_SITE}`,
    // 百川智能
    `DOMAIN-SUFFIX,baichuan-ai.com,${BIZ.CN_SITE}`,
    // 昆仑万维 Skywork
    `DOMAIN-SUFFIX,skywork.ai,${BIZ.CN_SITE}`,
    `DOMAIN-SUFFIX,tiangong.cn,${BIZ.CN_SITE}`,
    ...
    // ═══ v5.3.0: 新增 AI 服务域名 ═══
    // ── OpenAI 新入口（独立于 openai.com 的对话产品域名）──
    `DOMAIN-SUFFIX,chatgpt.com,${BIZ.AI}`,
    // ── Anthropic 新入口（独立于 anthropic.com 的对话产品域名）──
    `DOMAIN-SUFFIX,claude.ai,${BIZ.AI}`,
    // ── Meta AI 对话入口 ──
    `DOMAIN-SUFFIX,meta.ai,${BIZ.AI}`,
    // ── Mistral AI 新子域 ──
    `DOMAIN,chat.mistral.ai,${BIZ.AI}`,
    `DOMAIN,console.mistral.ai,${BIZ.AI}`,
    `DOMAIN,api.mistral.ai,${BIZ.AI}`,
    // ── AI 编程工具 ──
    `DOMAIN-SUFFIX,codeium.com,${BIZ.AI}`,
    `DOMAIN-SUFFIX,windsurf.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,windsurf.com,${BIZ.AI}`,
    `DOMAIN-SUFFIX,devin.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,cognition.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,replit.com,${BIZ.AI}`,
    `DOMAIN-SUFFIX,replit.dev,${BIZ.AI}`,
    `DOMAIN-SUFFIX,repl.it,${BIZ.AI}`,
    // ── AI 推理平台 ──
    `DOMAIN-SUFFIX,cerebras.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,cloud.cerebras.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,sambanova.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,samba.cloud,${BIZ.AI}`,
    // ── AI 生成平台 ──
    `DOMAIN-SUFFIX,fal.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,ideogram.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,leonardo.ai,${BIZ.AI}`,
    `DOMAIN-SUFFIX,playground.ai,${BIZ.AI}`,
    // ── 快手可灵AI视频生成（国际版需代理）──
    `DOMAIN-SUFFIX,klingai.com,${BIZ.AI}`,
    // ── DeepSeek 国际聊天入口（chat.deepseek.com 需代理，区别于主站 deepseek.com → 国内直连）──
    `DOMAIN,chat.deepseek.com,${BIZ.AI}`,
    ...
    // ═══ v5.3.0: 东南亚流媒体新增 ═══
    // ── Disney+ Hotstar（印度/东南亚/美国南亚社区，Disney+ 国际品牌）──
    `DOMAIN-SUFFIX,hotstar.com,${BIZ.STREAM_SEA}`,
    `DOMAIN-SUFFIX,hotstar-labs.com,${BIZ.STREAM_SEA}`,
    // ── JioCinema（印度免费流媒体，Reliance Jio 旗下）──
    `DOMAIN-SUFFIX,jiocinema.com,${BIZ.STREAM_SEA}`,
    // ── Astro Go（马来西亚最大流媒体平台）──
    `DOMAIN-SUFFIX,astro.com.my,${BIZ.STREAM_SEA}`,
    `DOMAIN-SUFFIX,astrogo.astro.com.my,${BIZ.STREAM_SEA}`,
    ...
    // ── v5.3.0: Amazon MGM+（Amazon收购MGM后流媒体品牌）──
    `DOMAIN-SUFFIX,mgmplus.com,${BIZ.STREAM_US}`,
    ...
    // ═══ v5.3.0: 国外游戏新增 ═══
    // ── Roblox（全球最大UGC游戏平台）──
    `DOMAIN-SUFFIX,roblox.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,rbxcdn.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,robloxcorp.com,${BIZ.GAME_INTL}`,
    // ── Minecraft/Mojang ──
    `DOMAIN-SUFFIX,minecraft.net,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,mojang.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,minecraftservices.com,${BIZ.GAME_INTL}`,
    // ── Krafton/PUBG（绝地求生开发商）──
    `DOMAIN-SUFFIX,krafton.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,pubg.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,pubgmobile.com,${BIZ.GAME_INTL}`,
    // ── Level Infinite（腾讯国际发行品牌：PUBG Mobile/Honor of Kings 等）──
    `DOMAIN-SUFFIX,levelinfinite.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,honorofkings.com,${BIZ.GAME_INTL}`,
    // ── 韩国游戏厂商 ──
    `DOMAIN-SUFFIX,nexon.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,nexon.co.jp,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,ncsoft.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,plaync.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,pearlabyss.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,smilegate.com,${BIZ.GAME_INTL}`,
    // ── Yostar（碧蓝航线/明日方舟日服发行商）──
    `DOMAIN-SUFFIX,yostar.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,yostar.jp,${BIZ.GAME_INTL}`,
    // ── Moonton（Mobile Legends开发商）──
    `DOMAIN-SUFFIX,moonton.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,mobilelegends.com,${BIZ.GAME_INTL}`,
    // ── 2K Games ──
    `DOMAIN-SUFFIX,2k.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,take2games.com,${BIZ.GAME_INTL}`,
    // ── Riot Games 补充域名 ──
    `DOMAIN-SUFFIX,lolusercontent.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,riotcdn.com,${BIZ.GAME_INTL}`,
    `DOMAIN-SUFFIX,lolesports.com,${BIZ.GAME_INTL}`,
