...
function injectRules(config) {
  config.rules = [
    ...
    // v5.1: Accademia 安全补充
    `RULE-SET,acc-hijackingplus,REJECT`,
    ...
    // v5.2.2 REMOVED: 金融支付/加密货币分组已移除，相关规则并入 GFW 组
    `DOMAIN-SUFFIX,binance.vision,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,binance.com,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,binance.info,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,binance.cloud,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,binance.me,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,binance.org,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,binancefuture.com,${BIZ.GFW}`,
    ...
    // ── Google 会议协作（分组已移除）──
    `DOMAIN-SUFFIX,meet.google.com,${BIZ.GLOBAL}`,
    `DOMAIN,meet.googleapis.com,${BIZ.GLOBAL}`,
    // ── Google 下载更新（分组已移除）──
    `DOMAIN-SUFFIX,dl.google.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,play.googleapis.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,android.clients.google.com,${BIZ.GLOBAL}`,
    `RULE-SET,googlefcm,${BIZ.GLOBAL}`,
    // ── Google 搜索引擎（分组已移除）──
    `RULE-SET,googlesearch,${BIZ.GLOBAL}`,
    `RULE-SET,googledrive,${BIZ.GLOBAL}`,
    `RULE-SET,googleearth,${BIZ.GLOBAL}`,
    `RULE-SET,google,${BIZ.GLOBAL}`,
    `RULE-SET,google-ip,${BIZ.GLOBAL},no-resolve`,
    // ════════════════════════════════════════════════════════════════
    ...
    // v5.1.8 FIX#13-P2: 微软 Delivery Optimization 遥测（分组已移除）
    `DOMAIN-SUFFIX,do.dsp.mp.microsoft.com,${BIZ.GLOBAL}`,
    `RULE-SET,acc-copilot,${BIZ.AI}`,
    // 加密货币/金融支付规则已移除（并入 GFW 组）
    `RULE-SET,cryptocurrency,${BIZ.GFW}`,
    `RULE-SET,binance,${BIZ.GFW}`,
    // v5.1: szkane Web3（DeFi/NFT/区块链RPC，已移除分组）
    `RULE-SET,szkane-web3,${BIZ.GFW}`,
    // 支付/银行规则已移除（并入 GFW 组）
    `RULE-SET,paypal,${BIZ.GFW}`,
    `RULE-SET,stripe,${BIZ.GFW}`,
    `RULE-SET,visa,${BIZ.GFW}`,
    `RULE-SET,tigerfintech,${BIZ.GFW}`,
    // v5.1.1: Accademia 银行 × 10国 + 虚拟金融 × 4（已移除分组）
    ...['US','UK','HK','SG','JP','AU','CA','DE','NL','FR'].map(cc => `RULE-SET,acc-bank-${cc.toLowerCase()},${BIZ.GFW}`),
    ...['paypal','wise','monzo','revolut'].map(svc => `RULE-SET,acc-vf-${svc},${BIZ.GFW}`),
    // 微软服务（分组已移除）
    `DOMAIN,login.live.com,${BIZ.GLOBAL}`,
    `DOMAIN,g.live.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,officeapps.live.com,${BIZ.GLOBAL}`,
    ...
    // 会议协作规则（分组已移除）
    `RULE-SET,zoom,${BIZ.GLOBAL}`,
    `RULE-SET,slack,${BIZ.GLOBAL}`,
    `RULE-SET,teams,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,webex.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,wbx2.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,ciscospark.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,notion.so,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,notion.site,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,figma.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,linear.app,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,atlassian.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,jira.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,trello.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,bitbucket.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,asana.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,monday.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,clickup.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,basecamp.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,airtable.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,miro.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,canva.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,coda.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,loom.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,larksuite.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,larkoffice.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,gotomeeting.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,logmein.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,goto.com,${BIZ.GLOBAL}`,
    `RULE-SET,atlassian,${BIZ.GLOBAL}`,
    `RULE-SET,notion,${BIZ.GLOBAL}`,
    `RULE-SET,teamviewer,${BIZ.GLOBAL}`,
    `RULE-SET,zoho,${BIZ.GLOBAL}`,
    `RULE-SET,salesforce,${BIZ.GLOBAL}`,
    `RULE-SET,zendesk,${BIZ.GLOBAL}`,
    `RULE-SET,intercom,${BIZ.GLOBAL}`,
    `RULE-SET,remotedesktop,${BIZ.GLOBAL}`,
    // v5.1: Accademia 远程桌面补充（分组已移除）
    `RULE-SET,acc-rustdesk,${BIZ.GLOBAL}`,
    `RULE-SET,acc-parsec,${BIZ.GLOBAL}`,
    ...
    `DOMAIN-SUFFIX,aws.amazon.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,elasticbeanstalk.com,${BIZ.GLOBAL}`,
    ...
    `RULE-SET,bing,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,yahoo.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,yahoo.co.jp,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,duckduckgo.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,ddg.co,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,brave.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,yandex.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,yandex.ru,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,ecosia.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,startpage.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,you.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,search.naver.com,${BIZ.GLOBAL}`,
    ...
    `RULE-SET,scholar,${BIZ.GLOBAL}`,
    `RULE-SET,yandex,${BIZ.GLOBAL}`,
    // 开发者服务规则（分组已移除）
    `RULE-SET,github,${BIZ.GLOBAL}`,
    `RULE-SET,onedrive,${BIZ.GLOBAL}`,
    `RULE-SET,microsoft,${BIZ.GLOBAL}`,
    `RULE-SET,microsoftedge,${BIZ.GLOBAL}`,
    // v5.1: Accademia 微软APP补充（分组已移除）
    `RULE-SET,acc-microsoftapps,${BIZ.GLOBAL}`,
    // 苹果服务规则（分组已移除）
    `RULE-SET,applemusic,${BIZ.GLOBAL}`,
    `RULE-SET,icloud,${BIZ.GLOBAL}`,
    `RULE-SET,apple,${BIZ.GLOBAL}`,
    `RULE-SET,appstore,${BIZ.GLOBAL}`,
    `RULE-SET,appletv,${BIZ.GLOBAL}`,
    `RULE-SET,applenews,${BIZ.GLOBAL}`,
    `RULE-SET,appledev,${BIZ.GLOBAL}`,
    `RULE-SET,appleproxy,${BIZ.GLOBAL}`,
    `RULE-SET,siri,${BIZ.GLOBAL}`,
    `RULE-SET,testflight,${BIZ.GLOBAL}`,
    `RULE-SET,applefirmware,${BIZ.GLOBAL}`,
    `RULE-SET,findmy,${BIZ.GLOBAL}`,
    // v5.1: Accademia 苹果补充（分组已移除）
    `RULE-SET,acc-applenews,${BIZ.GLOBAL}`,
    `RULE-SET,acc-apple,${BIZ.GLOBAL}`,
    `RULE-SET,docker,${BIZ.GLOBAL}`,
    `RULE-SET,gitlab,${BIZ.GLOBAL}`,
    `GEOSITE,category-dev,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,npmjs.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,npmjs.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,yarnpkg.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,pypi.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,pythonhosted.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,crates.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,rubygems.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,packagist.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,maven.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,nuget.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,cocoapods.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,stackoverflow.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,stackexchange.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,sstatic.net,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,vercel.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,vercel.app,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,netlify.app,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,netlify.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,pages.dev,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,workers.dev,${BIZ.GLOBAL}`,
    // v5.2.0 FIX#16: cloudflare.com 收窄为开发者入口精确匹配（分组已移除）
    `DOMAIN,dash.cloudflare.com,${BIZ.GLOBAL}`,
    `DOMAIN,api.cloudflare.com,${BIZ.GLOBAL}`,
    `DOMAIN,developers.cloudflare.com,${BIZ.GLOBAL}`,
    `DOMAIN,www.cloudflare.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,heroku.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,herokuapp.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,fly.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,railway.app,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,render.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,supabase.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,supabase.co,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,planetscale.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,neon.tech,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,digitalocean.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,vultr.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,linode.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,sentry.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,datadog.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,grafana.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,postman.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,jetbrains.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,hashicorp.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,terraform.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,vagrantup.com,${BIZ.GLOBAL}`,
    `RULE-SET,developer,${BIZ.GLOBAL}`,
    `RULE-SET,python,${BIZ.GLOBAL}`,
    `RULE-SET,gitbook,${BIZ.GLOBAL}`,
    `RULE-SET,jfrog,${BIZ.GLOBAL}`,
    `RULE-SET,sublimetext,${BIZ.GLOBAL}`,
    `RULE-SET,wordpress,${BIZ.GLOBAL}`,
    `RULE-SET,wix,${BIZ.GLOBAL}`,
    `RULE-SET,cisco,${BIZ.GLOBAL}`,
    `RULE-SET,ibm,${BIZ.GLOBAL}`,
    `RULE-SET,oracle,${BIZ.GLOBAL}`,
    `RULE-SET,unity,${BIZ.GLOBAL}`,
    // v5.1: szkane Developer（Docker镜像/模型文件下载，已移除分组）
    `RULE-SET,szkane-developer,${BIZ.GLOBAL}`,
    // 下载更新规则（分组已移除）
    `RULE-SET,systemota,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,windowsupdate.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,update.microsoft.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,download.microsoft.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,delivery.mp.microsoft.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,dl.delivery.mp.microsoft.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,officecdn.microsoft.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,officecdn.microsoft.com.edgesuite.net,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,download.mozilla.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,archive.mozilla.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,releases.ubuntu.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,archive.ubuntu.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,security.ubuntu.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,mirrors.kernel.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,dl.fedoraproject.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,repo.anaconda.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,conda.anaconda.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,repo.continuum.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,sourceforge.net,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,fosshub.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,filehippo.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,softonic.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,gcr.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,ghcr.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,quay.io,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,registry.k8s.io,${BIZ.GLOBAL}`,
    `RULE-SET,download,${BIZ.GLOBAL}`,
    `RULE-SET,ubuntu,${BIZ.GLOBAL}`,
    `RULE-SET,mozilla,${BIZ.GLOBAL}`,
    `RULE-SET,apkpure,${BIZ.GLOBAL}`,
    `RULE-SET,android,${BIZ.GLOBAL}`,
    // v5.1.9 CLEAN#1: googlefcm 已提升至防吞盾（FIX#14），dead rule 已清除
    `RULE-SET,intel,${BIZ.GLOBAL}`,
    `RULE-SET,nvidia,${BIZ.GLOBAL}`,
    `RULE-SET,dell,${BIZ.GLOBAL}`,
    `RULE-SET,hp,${BIZ.GLOBAL}`,
    `RULE-SET,canon,${BIZ.GLOBAL}`,
    `RULE-SET,lg,${BIZ.GLOBAL}`,
    // v5.1: Accademia MacApp升级规则（分组已移除）
    `RULE-SET,acc-macappupgrade,${BIZ.GLOBAL}`,
    ...
    // v5.2.2 REMOVED: BT/PT Tracker 分组已移除
    // BT/PT Tracker 规则并入 GLOBAL 组
    `GEOSITE,tracker,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,tracker.opentrackr.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,open.stealth.si,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,tracker.torrent.eu.org,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,exodus.desync.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,tracker.openbittorrent.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,tracker.publicbt.com,${BIZ.GLOBAL}`,
    `DOMAIN-SUFFIX,tracker.dler.org,${BIZ.GLOBAL}`,
    `RULE-SET,privatetracker,${BIZ.GLOBAL}`,
    // v5.1: Accademia eMule服务器
    `RULE-SET,acc-emuleserver,${BIZ.GLOBAL}`,
    // ═══ v5.1.5: 原「印尼本地」规则重分配 → 银行/证券归入 GFW ═══
    `DOMAIN-SUFFIX,bca.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,klikbca.com,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,bni.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,bri.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,bankmandiri.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,danamon.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,permatabank.com,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,cimbniaga.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,btn.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,ocbcnisp.com,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,banksinarmas.com,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,idx.co.id,${BIZ.GFW}`,
    `DOMAIN-SUFFIX,ksei.co.id,${BIZ.GFW}`,
    ...
    `GEOIP,google,${BIZ.GLOBAL},no-resolve`,
...
function pruneDisabledBusinessConfig(config) {
  if (Array.isArray(config['proxy-groups'])) {
    config['proxy-groups'] = config['proxy-groups'].filter(function(group) {
      return !(group && DISABLED_BIZ_GROUPS.has(group.name))
    })
    config['proxy-groups'].forEach(function(group) {
      if (!group || !Array.isArray(group.proxies)) return
      group.proxies = group.proxies.filter(function(proxyName) { return !DISABLED_BIZ_GROUPS.has(proxyName) })
    })
  }

  if (Array.isArray(config.rules)) {
    config.rules = config.rules.filter(function(rule) {
      return !DISABLED_BIZ_GROUPS.has(getRuleTarget(rule))
    })
  }
  ...
  if (config['rule-providers'] && typeof config['rule-providers'] === 'object') {
    ...
    Object.keys(config['rule-providers']).forEach(function(providerName) {
      if (!usedProviders.has(providerName)) delete config['rule-providers'][providerName]
    })
  }

  console.log(`[${VERSION}] Disabled business groups pruned`)
}
...
function cleanupSubscription(config) {
  ...
  config['proxy-groups'] = config['proxy-groups'].filter(g => {
    ...
    if (DISABLED_BIZ_GROUPS.has(g.name)) { deletedNames.add(g.name); return false }
