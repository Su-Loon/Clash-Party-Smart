...
//     - US 组移除 fallback：没有美国节点时不再降级到美洲/全节点组
//     - 修复前：智利-圣地亚哥、SingaporeSan、SEA-01 等节点被误分到美国组
...
function injectRules(config) {
  config.rules = [
    ...
    `DOMAIN-SUFFIX,aws.amazon.com,${BIZ.CLOUD_CDN}`,
    `DOMAIN-SUFFIX,elasticbeanstalk.com,${BIZ.CLOUD_CDN}`,
    ...
    `DOMAIN-SUFFIX,ddg.co,${SMART.GLOBAL}`,
    `DOMAIN-SUFFIX,brave.com,${SMART.GLOBAL}`,
    `DOMAIN-SUFFIX,yandex.com,${SMART.GLOBAL}`,
    `DOMAIN-SUFFIX,yandex.ru,${SMART.GLOBAL}`,
    `DOMAIN-SUFFIX,ecosia.org,${SMART.GLOBAL}`,
    `DOMAIN-SUFFIX,startpage.com,${SMART.GLOBAL}`,
    `DOMAIN-SUFFIX,you.com,${SMART.GLOBAL}`,
    `DOMAIN-SUFFIX,search.naver.com,${SMART.GLOBAL}`,
    ...
    `GEOIP,google,${SMART.GLOBAL},no-resolve`,
